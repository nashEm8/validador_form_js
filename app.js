...
const removeParagraph = () => {
  const paragraphSubmitFeedbackExist = document.querySelector('[data-feedback = "submit-feedback"]');
...
const showUsernameInfo = event => {
  ...
  if(!isUsernameValid){
    insertParagraphIntoDom(feedbackInvalid);
    return;
  }

  

  insertParagraphIntoDom(feedbackValid);
}
